...
async function buildMariahSystem() {
  ...
  let system = [
    ...
    'NAO TOCA (estrategico, financeiro, pessoal — sao dela): contratar, demitir, assinar contrato, posicionamento publico, oferta, preco, decisao de produto, resposta sensivel a mentorada em crise.',
    '',
